...
public class LoadRdfSkeletonCommand extends Command{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {        
            Project project = getProject(req); //this needs the project parameter, indicating the project on which the skeleton should be applied
    ...
    private void performProcess(
            ...
            String out = rdfSkeletonService.loadModel(request.getParameter("projectId")); //this is the project where the skeleton comes from
            ...
            if (historyEntry != null) {
                ...
                writer.key("skeleton"); writer.value(out); 
                writer.endObject();
